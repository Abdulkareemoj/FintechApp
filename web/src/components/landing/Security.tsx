					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						...
						>
							...
							<h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6">
								Bank-Level <span className="italic-accent">security</span> for
								your peace of mind
							</h2>
							<p className="text-muted-foreground text-lg mb-8 leading-relaxed">
								Your data is encrypted with the highest standards, ensuring
								privacy and protection. Trusted by thousands of users worldwide,
