	...
	navMain: [
		{
			...
			url: "#",
			items: [
				{ icon: BarChart3, title: "Overview", url: "/support/overview" },
				{ icon: Ticket, title: "Tickets", url: "/support/tickets" },
				{ icon: Users, title: "User Lookup", url: "/support/users" },
				{ icon: CreditCard, title: "Payments", url: "/support/payments" },
				{ icon: Receipt, title: "Statements", url: "/support/statements" },
			],
		},
		{
			title: "Resources",
