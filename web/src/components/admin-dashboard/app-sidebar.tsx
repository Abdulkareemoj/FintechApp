	...
	navMain: [
		{
			...
			url: "#",
			items: [
				{ icon: LayoutDashboard, title: "Admin", url: "/admin" },
				{ icon: Wallet, title: "Users", url: "/admin/users" },
				{ icon: CreditCard, title: "Compliance", url: "/admin/compliance" },
				{
					icon: ArrowLeftRight,
					title: "Transactions",
					url: "/admin/transactions",
				},
				{ icon: Send, title: "Overview", url: "/admin/overview" },
				{ icon: Receipt, title: "Reports", url: "/admin/reports" },
				{ icon: Shield, title: "Audit Trails", url: "/admin/audit-trails" },
			],
		},
		{
			title: "Other",
