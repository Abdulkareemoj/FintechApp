...
const payments = [
	...
	{
		id: "PAY-78235",
		customer: "sarah.smith@company.co",
		amount: 89.0,
		method: "Mastercard ****8888",
		status: "completed",
		date: "2024-01-20 14:28",
	},
	{
		id: "PAY-78236",
		customer: "mike.johnson@business.io",
		amount: 299.99,
		method: "Apple Pay",
		status: "pending",
	...
	{
		id: "PAY-78237",
		customer: "anna.wilson@store.com",
		amount: 45.5,
		method: "Visa ****1234",
		status: "failed",
	...
	{
		id: "PAY-78239",
		customer: "emma.davis@email.com",
		amount: 75.25,
		method: "Mastercard ****5555",
		status: "refunded",
		date: "2024-01-20 13:42",
	},
	{
		id: "PAY-78240",
		customer: "james.miller@corp.co",
		amount: 520.0,
										...
										{filteredPayments.map((payment) => (
											...
											>
												...
												<TableCell>
													<Badge
														variant="outline"
														className={`gap-1.5 ${statusConfig[payment.status].color}`}
													>
