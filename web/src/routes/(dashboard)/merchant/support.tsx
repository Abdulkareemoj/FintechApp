...
const faqs = [
	{
		...
		answer:
			"Standard settlements take 2-3 business days. You can request instant payouts for a small fee if you need funds faster.",
	},
	{
		question: "What are your transaction fees?",
		answer:
			"Our standard rate is 2.9% + $0.30 per successful transaction. Volume discounts are available for high-volume merchants.",
	},
	{
		question: "How do I handle refunds?",
		answer:
			"Refunds can be processed directly from the Payments page. Click on any transaction and select 'Refund'. Funds typically return to customers within 5-10 business days.",
	},
	{
		question: "Is my data secure?",
		answer:
			"Absolutely. We are PCI DSS Level 1 certified and use industry-standard encryption. All sensitive data is tokenized and we never store raw card numbers.",
	},
];
				...
				<main className="mx-auto space-y-8 px-6 py-8">
					...
					>
						...
						<p className="text-muted-foreground mt-1">
							Get help with your merchant account and integration.
						</p>
					</motion.div>
					{/* Contact Options */}
					<div className="grid gap-4 md:grid-cols-3">
						{[
							...
							{
								title: "Email Support",
								description: "support@finpay.com",
								icon: Mail,
								action: "Send Email",
								available: true,
							},
					...
					>
						<Card className="bg-card/50 backdrop-blur-sm border-border/50">
							<CardHeader>
								...
								<CardDescription>
									Documentation and guides for integration.
								</CardDescription>
							</CardHeader>
							<CardContent>
								<div className="grid gap-4 md:grid-cols-3">
