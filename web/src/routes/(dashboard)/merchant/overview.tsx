				...
				<main className="mx-auto space-y-8 px-6 py-8">
					...
					>
						...
						<p className="text-muted-foreground mt-1">
							Track your payments, revenue, and business performance.
						</p>
					</motion.div>
					{/* KPI Cards */}
								...
								<Card className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 transition-colors">
									<CardContent className="p-6">
										<div className="flex items-center justify-between">
											...
											<div
												className={`flex items-center gap-1 text-sm ${kpi.changeType === "positive" ? "text-emerald-400" : "text-red-400"}`}
											>
