				...
				<main className="mx-auto space-y-8 px-6 py-8">
					...
					>
						...
						<p className="text-muted-foreground mt-1">
							Manage your merchant account and payment preferences.
						</p>
					</motion.div>
							...
							>
								<Card className="bg-card/50 backdrop-blur-sm border-border/50">
									<CardHeader>
										...
										<CardDescription>
											Update your business details and legal information.
										</CardDescription>
									</CardHeader>
							...
							>
								...
								<Card className="bg-card/50 backdrop-blur-sm border-border/50">
									<CardHeader>
										...
										<CardDescription>
											Set your default and accepted currencies.
										</CardDescription>
									</CardHeader>
									<CardContent className="space-y-4">
										<div className="grid gap-4 md:grid-cols-2">
										...
										{[
											{
												...
												description:
													"Get notified for every successful payment",
												enabled: true,
											},
											{
												name: "Payment Failed",
												description:
													"Alerts when payments fail or are declined",
												enabled: true,
											},
											{
												name: "Large Transactions",
												description:
													"Notifications for transactions over $1,000",
												enabled: true,
											},
											{
												name: "Settlement Complete",
												description: "When funds are deposited to your bank",
												enabled: true,
											},
											{
												name: "Daily Summary",
												description: "Daily recap of all transactions",
												enabled: false,
											},
											{
												name: "Weekly Reports",
							...
							>
								<Card className="bg-card/50 backdrop-blur-sm border-border/50">
									<CardHeader>
										...
										<CardDescription>
											Customize the appearance of your payment pages.
										</CardDescription>
									</CardHeader>
									<CardContent className="space-y-6">
										<div className="grid gap-4 md:grid-cols-2">
										...
										<div className="space-y-2">
											...
											<Textarea
												defaultValue="Thank you for your purchase! Your order is being processed."
												className="bg-muted/50"
											/>
										</div>
										<Button className="bg-primary hover:bg-primary/90">
										...
										{[
											{
												name: "3D Secure",
												description:
													"Require 3DS verification for card payments",
												enabled: true,
											},
											{
												name: "CVV Verification",
												description: "Always require CVV for transactions",
												enabled: true,
											},
											{
											...
											},
											{
												...
												description: "Decline payments from VPN/proxy IPs",
												enabled: false,
											},
										].map((setting) => (
											<div
