...
const quickStats = [
  { label: "Open Tickets", value: "24", icon: Ticket, color: "blue", change: "+12%" },
  { label: "Avg Response Time", value: "2.3 min", icon: Clock, color: "green", change: "-18%" },
  { label: "Customer Satisfaction", value: "94%", icon: TrendingUp, color: "emerald", change: "+3%" },
  { label: "Resolved Today", value: "47", icon: CheckCircle2, color: "violet", change: "+8%" },
];
          ...
          >
            <Card className="bg-card/50 backdrop-blur-sm border-border/50">
              <CardHeader>
                ...
                <CardDescription>Common support tasks and tools</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4 md:grid-cols-4">
                  <Button className="h-20 flex-col gap-2 bg-violet-500 hover:bg-violet-600">
          ...
          >
            <Card className="bg-card/50 backdrop-blur-sm border-border/50">
              <CardHeader>
                ...
                <CardDescription>Customer communication channels and status</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="flex items-center gap-3 p-4 rounded-lg border border-border/50 bg-muted/20">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">12 active conversations</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 rounded-lg border border-border/50 bg-muted/20">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">8 active chats</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 rounded-lg border border-border/50 bg-muted/20">
                    <div className="h-10 w-10 rounded-lg bg-violet-500/10 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">3 calls in queue</p>
                    </div>
                  </div>
                </div>
              </CardContent>
