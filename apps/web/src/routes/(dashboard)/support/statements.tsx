...
const stats = [
  ...
  { label: "Completed Today", value: "23", icon: CheckCircle2, color: "emerald" },
    ...
    <SupportLayout>
      <div className="min-h-screen bg-background">
        <main className="mx-auto space-y-8 px-6 py-8">
          ...
          >
            <h1 className="text-3xl font-bold tracking-tight">Statement Requests</h1>
          ...
          >
            <Card className="bg-card/50 backdrop-blur-sm border-border/50">
              <CardHeader>
                ...
                <CardDescription>Common statement-related tasks</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-4 md:grid-cols-4">
          ...
          >
            <Card className="bg-card/50 backdrop-blur-sm border-border/50">
              <CardHeader>
                <CardTitle className="text-lg font-semibold">Statement Requests</CardTitle>
                <CardDescription>Customer document requests and processing status</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                  ...
                  <TableBody>
                    {statementRequests.map((request) => (
                      <TableRow key={request.id}>
                        ...
                        <TableCell className="font-medium">{request.period}</TableCell>
                        <TableCell>
                          <Badge
                            variant={
