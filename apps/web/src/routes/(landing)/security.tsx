						...
						<div className="grid lg:grid-cols-2 gap-12 items-center">
							...
							>
								<h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6">
									Your <span className="italic-accent">security</span> is our
									priority
								</h1>
					...
					<div className="container mx-auto px-4 sm:px-6 lg:px-8">
						...
						>
							<h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
								Enterprise-grade{" "}
								<span className="italic-accent">protection</span>
							</h2>
					...
					<div className="container mx-auto px-4 sm:px-6 lg:px-8">
						...
						>
							...
							<p className="text-primary-foreground/80 max-w-2xl mx-auto mb-8">
								If unauthorized transactions occur due to a security breach on
								our end, we guarantee 100% reimbursement. Your trust is our most
								valuable asset.
							</p>
							<Button
								size="xl"
