  ...
  navMain: [
    {
      ...
      url: "#",
      items: [
        { icon: LayoutDashboard, title: "Dashboard", url: "/merchant/overview" },
        { icon: Wallet, title: "API Keys", url: "/merchant/api-keys" },
        { icon: CreditCard, title: "Payments", url: "/merchant/payments" },
        { icon: TrendingUp, title: "Analytics", url: "/merchant/analytics" },
        { icon: BarChart3, title: "Webhooks", url: "/merchant/webhooks" },
      ],
    },
    {
      title: "Other",
