      ...
      <Card className="relative overflow-hidden border-0 shadow-elevated">
        ...
        <CardContent className="relative p-8">
          <div className="mb-6 flex items-start justify-between">
            <div>
              <p className="mb-1 font-medium text-primary-foreground/70 text-sm">
                Total Balance
              </p>
              <div className="flex items-center gap-3">
                <h2 className="number-display font-bold text-4xl text-primary-foreground tracking-tight">
          ...
          <div className="flex gap-3">
            ...
            <Button
              className="flex-1 border-primary-foreground/30 bg-transparent font-semibold text-primary-foreground hover:bg-white/10"
              size="lg"
              variant="outline"
            >
